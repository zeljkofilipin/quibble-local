...
- Long-running scripts (`dependencies_minimal`, `run_all`, `run_required`, `test_integration`) source `lib/inhibit_sleep` to prevent the machine from suspending
