...
- Long-running scripts (`dependencies_minimal`, `dependencies_minimal_bottom_up`, `dependencies_minimal_gated`, `dependencies_minimal_thorough`, `run_selenium_tests_all`, `run_selenium_tests_required`, `test_integration`) source `lib/inhibit_sleep` to prevent the machine from suspending
